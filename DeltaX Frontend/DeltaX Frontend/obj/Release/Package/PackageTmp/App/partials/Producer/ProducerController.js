...
app.controller('ProducerController', function ($scope, $http, ConstantService) {
    ...
    $scope.addPerson = function () {
        $http({
            ...
            data: { Name: $scope.person.personname, DOB: $scope.person.DOB, Sex: $scope.person.gender, Bio: $scope.person.bio, Designation: 'producer' },//forms user object
